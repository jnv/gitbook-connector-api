...
## Get all accounting environments

Returns all accounting environments supported by the API.

### Request

`[PlatformAddress]/api/connector/v1/accountingEnvironments/getAll`
...
```javascript
{
    "AccountingEnvironments": [
        {
            "Code": "DEFAULT",
            "EnglishName": "Default",
            "CustomerLegalIdentifiers": [],
            "CompanyLegalIdentifiers": []
        },
        {
            "Code": "FR",
            "EnglishName": "France",
...
| Property | Type |  | Description |
| --- | --- | --- | --- |
| `Code` | string | required | Name of property. |
